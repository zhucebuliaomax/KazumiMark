...
class AppDelegate: FlutterAppDelegate {
    ...
    override func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let channel = FlutterMethodChannel.init(name: "app.kazumimax/intent", binaryMessenger: controller.engine.binaryMessenger)
        self.menuChannel = FlutterMethodChannel.init(name: "app.kazumimax/appmenu",binaryMessenger: controller.engine.binaryMessenger)
        ...
        let storageChannel = FlutterMethodChannel.init(name: "app.kazumimax/storage", binaryMessenger: controller.engine.binaryMessenger)
