...
void FlutterWindow::RegisterIntentChannel() {
  auto window_channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          flutter_controller_->engine()->messenger(), "app.kazumimax/intent",
...
void FlutterWindow::RegisterStorageChannel() {
  auto storage_channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          flutter_controller_->engine()->messenger(), "app.kazumimax/storage",
          &flutter::StandardMethodCodec::GetInstance());
...
void FlutterWindow::RegisterShortcutChannel() {
  auto channel = std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
      flutter_controller_->engine()->messenger(), "app.kazumimax/shortcut",
      &flutter::StandardMethodCodec::GetInstance());
  ...
  channel->SetMethodCallHandler([](const auto& call, auto result) {
    ...
    bool success = ShortcutUtils::CreateDesktopShortcut(L"Kazumi Max", L"Kazumi Max - Anime Player");
    if (success) {
